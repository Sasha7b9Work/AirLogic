...
__attribute__((optimize(3))) float KalmanFilter::updateEstimate(float mea) {
...
float KalmanFilter::getKalmanGain() { return _kalman_gain; }

float KalmanFilter::getEstimateError() { return _err_estimate; }