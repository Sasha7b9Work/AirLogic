...
typedef struct __attribute__((aligned(256))) {
  ...
  float voltageCorrection = 0.0;

  uint8_t presets[5] = {90, 70, 50, 30, 10};
  uint8_t curHeight = {50};

  bool compressorEnabled = true;

  /* holder for sensors raw calbration data */
  float sensorRawMin[4] = {4095.0, 0.0, 0.0, 0.0};
  float sensorRawMax[4] = {0.0, 4095.0, 4095.0, 4095.0};
  float sensorAutoMin[4] = {4095.0, 0.0, 0.0, 0.0};
  float sensorAutoMax[4] = {0.0, 4095.0, 4095.0, 4095.0};
  uint8_t lastPreset[4] = {50, 50, 50, 50};
